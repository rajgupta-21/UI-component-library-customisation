      ...
      <main>
        ...
        <section id="button" className="mb-8">
          <div className="glass-card border border-white/10 p-6 rounded-2xl">
            ...
            <CodeSnippet>{`import { Button } from '@your-scope/newgen-ui';\n\n<Button>Primary</Button>`}</CodeSnippet>
          </div>
        </section>
        ...
        <section id="card" className="mb-8">
          <div className="glass-card border border-white/10 p-6 rounded-2xl">
            ...
            <div className="mt-4">
              <CodeSnippet>{`import { Card } from '@your-scope/newgen-ui';\n\n<Card title="Card title">...</Card>`}</CodeSnippet>
            </div>
          </div>
        </section>
        ...
        <section id="navbar" className="mb-8">
          <div className="glass-card border border-white/10 p-6 rounded-2xl">
            ...
            <CodeSnippet>{`import { Navbar } from '@your-scope/newgen-ui';\n\n<Navbar />`}</CodeSnippet>
          </div>
        </section>
        ...
        <section id="dialog" className="mb-8">
          <div className="glass-card border border-white/10 p-6 rounded-2xl">
            ...
            <div className="mt-4">
              <CodeSnippet>{`import { Dialog } from '@your-scope/newgen-ui';\n\n<Dialog open={true} onClose={() => {}} title="Example">Content</Dialog>`}</CodeSnippet>
            </div>
          </div>
        </section>
        {/* CAROUSEL DEMO */}
...
<Carousel slides={slides} theme={{ background: "#f3f3f3", indicator: "#7C3AED" }} autoPlay autoPlayInterval={4000} />`}
              </CodeSnippet>
            </div>
          </div>
        </section>
